...
class FID(metric_base.MetricBase):
    ...
    def _evaluate(self, Gs, Gs_kwargs, num_gpus):
        ...
        print(f'minibatch_size is {minibatch_size}, num_gpus is {num_gpus}, minibatch_per_gpu is {self.minibatch_per_gpu}')
        # inception = misc.load_pkl('http://d36zk2xti64re0.cloudfront.net/stylegan1/networks/metrics/inception_v3_features.pkl')
        inception = misc.load_pkl("/apdcephfs/share_1367250/yuesongtian/pretrained_models/inception_v3_features.pkl")
