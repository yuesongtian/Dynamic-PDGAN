...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    #EasyDict(name='ppl_wend',  func_name='metrics.perceptual_path_length.PPL',     num_samples=100000, epsilon=1e-4, space='w', sampling='end', crop=True, minibatch_per_gpu=16, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    ...
    #EasyDict(name='ppl2_wend', func_name='metrics.perceptual_path_length.PPL',     num_samples=100000, epsilon=1e-4, space='w', sampling='end', crop=False, minibatch_per_gpu=16, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
