...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics, run_name=None):
    ...
    #G         = EasyDict(func_name='training.networks_stylegan2.G_main_styles', synthesis_func='G_synthesis_stylegan2_searchStyles', mapping_func='G_mapping_styles')       # Options for generator network.
    G         = EasyDict(func_name='training.networks_stylegan2.G_main', synthesis_func='G_synthesis_stylegan2_compress', channels_fraction=2)       # Options for generator network.
    #D         = EasyDict(func_name='training.networks_stylegan2.D_stylegan2_search')  # Options for discriminator network.
    D         = EasyDict(func_name='training.networks_stylegan2.D_stylegan2_distill', channels_fraction=2)  # Options for discriminator network.
