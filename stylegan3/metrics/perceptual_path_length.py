...
def compute_ppl(opts, num_samples, epsilon, space, sampling, crop, batch_size):
    ...
    vgg16_path = '/apdcephfs/share_1367250/yuesongtian/pretrained_models/stylegan3/vgg16.pkl'
    #vgg16 = metric_utils.get_feature_detector(vgg16_url, num_gpus=opts.num_gpus, rank=opts.rank, verbose=opts.progress.verbose)
    vgg16 = metric_utils.get_feature_detector(vgg16_path, num_gpus=opts.num_gpus, rank=opts.rank, verbose=opts.progress.verbose)
